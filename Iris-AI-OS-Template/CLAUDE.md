...
> "I need an API key to think. You can grab one from Anthropic's console."
> "Drop it in your .env file — I'll wait."
...
> "Free tier. Takes two minutes. pinecone.io"

3. **Telegram** — This is the most important one. Save it for last so it feels like the capstone.
